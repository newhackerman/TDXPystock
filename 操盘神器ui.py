...
"selection-background-color: rgb(0, 0, 62);")
        ...
        self.textEdit_superAmount.setGeometry(QtCore.QRect(0, 40, 491, 341))
...
"border-color: rgb(5, 9, 255);")
        ...
        self.textEdit_drogMoniter.setGeometry(QtCore.QRect(0, 390, 501, 231))
...
"border-color: rgb(5, 9, 255);")
        ...
        self.label_superAmount.setGeometry(QtCore.QRect(-10, 30, 501, 16))
        ...
        self.label_drogstock.setGeometry(QtCore.QRect(0, 380, 491, 21))
...
"}")
        ...
        self.pushButtonflushquotestart.setGeometry(QtCore.QRect(240, 10, 61, 28))
...
"}")
        ...
        self.pushButtonflushquotestop = QtWidgets.QPushButton(self.MYSTOCK)
        self.pushButtonflushquotestop.setGeometry(QtCore.QRect(160, 10, 61, 28))
...
"} ")
        ...
        self.tableView_zhangtingdata.setGeometry(QtCore.QRect(0, 630, 1521, 321))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"} ")
        ...
        self.tableView_zhangtingdata.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.tableView_zhangtingdata.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
...
"font: 11pt \"Agency FB\";")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1937, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"selection-color:rgb(40,150,200);")
        ...
        self.sorthAmtmenu.addAction(self.action_opennorthanalyiesForm)
        self.sorthAmtmenu.addAction(self.actionsuportjust30dayNorthData)
        self.sorthAmtmenu.addAction(self.actionnorthTop20Select)
        self.sorthAmtmenu.addAction(self.actionnorthbuyup)
        self.sorthAmtmenu.addSeparator()
        self.sorthAmtmenu.addAction(self.actionnorthDataforone)
        self.sorthAmtmenu.addAction(self.actionnorthFindstockF10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonvoiceremainder.setText(_translate("MainWindow", "语音开关"))
        ...
        self.southAmtmenu.setTitle(_translate("MainWindow", " 南资分析 "))
        self.sorthAmtmenu.setTitle(_translate("MainWindow", " 北资分析 "))
        ...
        self.actionSouthmoreFunction.setText(_translate("MainWindow", "更多功能"))
